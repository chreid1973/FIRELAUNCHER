...
object IconPackCatalog {
    ...
    private val aliasMap = mapOf(
        ...
        "nba" to "nba",
        "nfl" to "nfl",
        "ocean streamz" to "oceanstreamz",
        "oceanstreamz" to "oceanstreamz",
        "iptv smarters" to "iptvsmarters",
        "iptv smarters pro" to "iptvsmarters",
        "smarters pro" to "iptvsmarters",
        "ufc" to "ufc",
        "f1" to "f1",
        "formula 1" to "f1",
        "kodi" to "kodi",
    ...
    private val fileMap = mapOf(
        ...
        "nba" to "NBA.png",
        "nfl" to "nfl.png",
        "oceanstreamz" to "OCEANSTREAMZ.png",
        "iptvsmarters" to "IPTVSMARTERS.png",
